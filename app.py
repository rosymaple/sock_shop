...
# add_to_cart function sets up the add to cart page,
# with product id, quantity, and custom_text
...
# The cart() function sets up the cart page, and gets the cart
# with the items for the current browser session 
@app.route('/cart')
def cart():
    cart = session.get('cart', [])
